...
module DocxTemplater
  class TemplateProcessor
    ...
    def enter_multiple_values(document, key)
      ...
      if !begin_row_template ^ !end_row_template
        fail "unmatched template markers: #{begin_row} nil: #{begin_row_template.nil?}, #{end_row} nil: #{end_row_template.nil?}. This could be because word broke up tags with it's own xml entries. See README."
      elsif !begin_row_template || !end_row_template
        return xml.to_s
      end
